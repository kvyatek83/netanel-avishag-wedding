...
module.exports = {
  ...
  getWeddingDetails() {
    return {
      ...
      weddingMonth: Number(process.env.WEDDING_MONTH) || 11,
      weddingDay: Number(process.env.WEDDING_DAY) || 21,
      weddingHour: Number(process.env.WEDDING_HOUE) || 19,
      weddingMinute: Number(process.env.WEDDING_MINUTE) || 0,
